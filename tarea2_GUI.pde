...
void setup() {
  ...
  colorWheel = new ColorWheel(25*width/68, 19.5*height/68);
  // carga la imagen que sirve de base para el control
  fondoColorWheel = loadImage("circulo cromatico.png");
}
